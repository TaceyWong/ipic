<template>
  ...
  >
    <header class="flex items-center justify-between w-full">
      <h1 class="font-medium text-2xl text-green">设置选项</h1>
    ...
    >
      <h2 class="mb-3 text-gray-200 text-xl w-full">一般通用设置</h2>
    ...
    >
      <header class="flex px-2 w-full">
        <h2 class="text-gray-200 text-xl">调整大小</h2>
        <button
          @click="addSize"
          class="
            border-0
            focus:outline-none
            hover:green hover:text-green
            ml-8
            ta-slow
          "
          v-tooltip.right-end="{
            content: '添加一个进行转换的图片尺寸',
            delay: 600,
          }"
        >
          添加尺寸 +
      ...
      >
        ...
        <div class="mb-2 lg:mb-0 px-2 w-full sm:w-1/2 lg:w-auto">
          <label class="block xl:inline-block mb-2 mr-4">策略</label>
    ...
    <div class="mb-4 w-full">
      <button
        ...
        class="
          ...
          btn
          focus:outline-none
          hover:bg-green hover:border-green hover:text-gray-900
          ml-auto
          ta-slow
        "
      >
...
export default {
  ...
  methods: {
    ...
    strategyTooltip(s) {
      switch (s.strategy) {
        case 0: {
          return '[智能裁剪]调整图像到指定的尺寸，从中心裁剪多余的部分。'
        }
        case 1: {
          return "[自适应]调整图像的大小以适应指定的尺寸，保持图像的宽高比。"
        }
        default: {
          return ''
        }
